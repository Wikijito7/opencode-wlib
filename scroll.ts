/**
 * opencode-wlib — scroll state for scrollbox dialogs.
 *
 * Solid-agnostic: takes the host's `createSignal` so it works inside any
 * opencode TUI plugin. Tracks overflow/position and exposes up/down/page
 * handlers for the dialog key layer. This is the canonical full version —
 * plugin-local trimmed copies drift (e.g. missing page up/down).
 */
